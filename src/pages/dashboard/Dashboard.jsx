...
import { IoBagHandle, IoPieChart, IoPeople, IoCart, IoPaw, IoMedical, IoStorefront } from 'react-icons/io5'
		...
		<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
			<BoxWrapper>
				<div className="rounded-full h-12 w-12 flex items-center justify-center bg-green-500">
					<IoPaw className="text-2xl text-white" />
				</div>
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Total Pets</span>
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold">156</strong>
					</div>
				</div>
			</BoxWrapper>
			<BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Pending Adoptions</span>
					<div className="flex items-center">
			...
			<BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Today's Appointments</span>
					<div className="flex items-center">
			...
			<BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">Active Boardings</span>
					<div className="flex items-center">
...
function TransactionChart() {
	return (
		<div className="h-88 bg-white p-4 rounded-sm border border-gray-200 flex flex-col flex-1">
			<strong className="text-gray-700 font-medium">Monthly Activity Overview</strong>
