...
export default function EditPetPage() {
  ...
  if (loadingPet || loadingTypes || loadingBreeds) {
    return (
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <Card className="shadow-sm border border-slate-100 bg-white">
          <CardContent className="py-10 space-y-4 text-center">
            <p className="text-red-500 font-medium">Failed to load pet.</p>
            <Button
              variant="outline"
  ...
  if (!pet) {
    return (
      <div className="p-6 max-w-4xl mx-auto">
        <Card className="shadow-sm border border-slate-100 bg-white">
          <CardContent className="py-10 space-y-4 text-center">
            <p className="text-slate-900 font-semibold">Pet not found</p>
            <Button
              variant="outline"
              onClick={() => navigate("/dashboard/pet-management")}
            >
